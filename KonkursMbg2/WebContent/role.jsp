...
<br>
<button id="dodaj" class="dodaj" onclick="document.getElementById('m01').style.display='block'" style="width:auto;">+ Dodaj nową rolę</button>
<div id="m01" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/rola">
...
<div id="m02" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/rola">
    ...
    <input type="hidden" id="id_rola" name="id_rola">
...
<div id="m03" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/rola">
    ...
    <div class="container">
    <h2>Usuwanie roli</h2>
    <h3>Czy na pewno chcesz usunąć tą rolę?</h3>
    <input type="hidden" id="id_rola" name="id_rola">
...
$(document).on('click', '.edit', function() {
    ...
    $('#m02 input[name=id_rola]').val(rowData.eq(0).text());
...
$(document).on('click', '.delete', function() {
    var rowData = $(this).closest('tr').find('td');
    $('#m03 input[name=id_rola]').val(rowData.eq(0).text());
