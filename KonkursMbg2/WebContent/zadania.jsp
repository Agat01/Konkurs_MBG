...
<br>
<button id="dodaj" class="dodaj" onclick="document.getElementById('m01').style.display='block'" style="width:auto;">+ Dodaj nowe zadanie</button>
<div id="m01" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/zadanie">
    ...
    <input type="hidden" id="metoda" name="metoda" value="add">
      <div>
        ...
        <div>
            <label for="max_liczba_pkt">Max liczba punktów:</label>
            <input type="number" id="max_liczba_pkt" name="max_liczba_pkt"/>
        </div>
        <div>
...
<div id="m02" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/zadanie">
    ...
    <div class="container">
    <h2>Edytowanie zadania</h2>
    <input type="hidden" id="id_zadanie" name="id_zadanie">
...
<div id="m03" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/zadanie">
    ...
    <h2>Usuwanie zadania</h2>
     <h3>Usunięcie zadania spowoduje usunięcie przypisanych do niego wyników!</h3>
...
$(document).on('click', '.edit', function() {
    ...
    $('#m02 input[name=id_zadanie]').val(rowData.eq(0).text());
    $('#m02 input[name=nazwa]').val(rowData.eq(1).text());
    $('#m02 input[name=max_liczba_pkt]').val(rowData.eq(2).text());
    document.getElementById('m02').style.display='block';
});

$(document).on('click', '.delete', function() {
    var rowData = $(this).closest('tr').find('td');
    $('#m03 input[name=id_zadanie]').val(rowData.eq(0).text());
