...
<br>
<button id="dodaj" class="dodaj" onclick="document.getElementById('m01').style.display='block'" style="width:auto;">+ Dodaj nowe województwo</button>
<div id="m01" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/wojewodztwo">
    <div class="imgcontainer">
      <span onclick="document.getElementById('m01').style.display='none'" class="close" title="Close Modal">&times;</span>
      
    </div>
    <div class="container">
    <h2>Dodawanie nowego województwa</h2>
...
<div id="m02" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/wojewodztwo">
    ...
    <div class="container">
    <h2>Edytowanie województwa</h2>
    <input type="hidden" id="id_wojewodztwo" name="id_wojewodztwo">
...
<div id="m03" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/wojewodztwo">
    ...
    <div class="container">
    <h2>Usuwanie województwa</h2>
    <h3>Czy na pewno chcesz usunąć to województwo?</h3>
    <input type="hidden" id="id_wojewodztwo" name="id_wojewodztwo">
...
$(document).on('click', '.edit', function() {
    ...
    $('#m02 input[name=id_wojewodztwo]').val(rowData.eq(0).text());
...
$(document).on('click', '.delete', function() {
    var rowData = $(this).closest('tr').find('td');
    $('#m03 input[name=id_wojewodztwo]').val(rowData.eq(0).text());
