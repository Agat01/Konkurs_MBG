...
<br>
<button id="dodaj" class="dodaj" onclick="document.getElementById('m01').style.display='block'" style="width:auto;">+ Dodaj nowego dyrektora</button>
<div id="m01" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/dyrektor">
    <div class="imgcontainer">
      <span onclick="document.getElementById('m01').style.display='none'" class="close" title="Close Modal">&times;</span>
      
    </div>
    <div class="container">
    <h2>Dodawanie nowego dyrektora</h2>
...
<div id="m02" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/dyrektor">
    ...
    <div class="container">
    <h2>Edytowanie danych dyrektora</h2>
    <input type="hidden" id="id_dyrektor" name="id_dyrektor">
...
<div id="m03" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/dyrektor">
    ...
    <div class="container">
    <h2>Usuwanie dyrektora</h2>
    <h3>Usunięcie dyrektora spowoduje usunięcie przypisanej do niego szkoły, klas i nauczycieli!</h3>
    <h3>Czy na pewno chcesz usunąć tego dyrektora?</h3>
    <input type="hidden" id="id_dyrektor" name="id_dyrektor">
...
$(document).on('click', '.edit', function() {
    ...
    $('#m02 input[name=id_dyrektor]').val(rowData.eq(0).text());
...
$(document).on('click', '.delete', function() {
    var rowData = $(this).closest('tr').find('td');
    $('#m03 input[name=id_dyrektor]').val(rowData.eq(0).text());
