...
<br>
<button id="dodaj" class="dodaj" onclick="document.getElementById('m01').style.display='block'" style="width:auto;">+ Dodaj nowy język obcy</button>
<div id="m01" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/jezyk">
    <div class="imgcontainer">
      <span onclick="document.getElementById('m01').style.display='none'" class="close" title="Close Modal">&times;</span>
      
    </div>
    <div class="container">
    <h2>Dodawanie nowego języka obcego</h2>
...
<div id="m02" class="modal">
  <form class="modal-content animate" method="post" action="/KonkursMbg/jezyk">
    ...
    <div class="container">
    <h2>Edytowanie języka obcego</h2>
    <input type="hidden" id="id_jezyk" name="id_jezyk">
...
$(document).on('click', '.edit', function() {
    ...
    $('#m02 input[name=id_jezyk]').val(rowData.eq(0).text());
...
$(document).on('click', '.delete', function() {
    var rowData = $(this).closest('tr').find('td');
    $('#m03 input[name=id_jezyk]').val(rowData.eq(0).text());
